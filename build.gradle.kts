...
group = "btc.renaud.vanillaenchantextension"
...
typewriter {
    ...
    extension {
        ...
        shortDescription = "Typewriter extension for Vanilla Enchantments support."
        description =
            "This extension adds support for vanilla Minecraft enchantments in Typewriter, allowing you to configure triggers for enchantment application in both enchanting tables and anvils."
